...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia de amor.  A pesar de nuestra situación actual, me alegra mucho estar aún a tu lado y disfrutar cada momento, eres la persona que amaré de por vida. ¡Te Amoo🤍!`;
  }
});
...
const mensajes = [
    "Eres lo más especial que habita en toda mi vida🤍",
    "Haces brillar a mi corazón de la manera más bonita posible✨",
    "Sin ti mi vida no  tendría un sentido tan bonito y especial💕",
    "El brillo de mis ojos se debe a tu linda sonrisa🥹",
    "Tú vida es lo más bonito de esta existencia🤍",
    "Verte feliz es lo que más alegría le da a mi vida❤️‍🩹",
